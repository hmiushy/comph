...
## -------------
#bfrt.p4_main.pipe.SwitchIngress.comp.mirror_fwd.entry_with_set_md(valid=1,ing_ses=27,port=9).push()
#bfrt.mirror.cfg.entry_with_normal(sid=27, direction="INGRESS", session_enable=True, ucast_egress_port=2, ucast_egress_port_valid=1).push()


bfrt.p4_main.pipe.SwitchIngress.comp.ipv4_set_port.entry_with_set_port(valid=1,port=9).push()
bfrt.p4_main.pipe.SwitchEgress.comp.mirror_fwd.entry_with_set_md(valid=1,eg_ses=28).push()
